...
# Nova função de sampling para dropout
...
def generate_random_config() -> Dict[str, Any]:
    ...
    cfg = {
        ...
        "model_params": {
            "hidden_layers": [256, 256, 256, 256], # sample_hidden_layers(),
            # Adicionado p_dropout ao gerador de config
            "p_dropout": 0.0, # sample_p_dropout(),
        },
    }
    return cfg
